...
public class PerspectiveListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<com.plow.myoak.utils.MenuListProvider.MenuItem>(getActivity(),
				android.R.layout.simple_list_item_activated_1,
				android.R.id.text1, menu.getMenu()));
	}
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(menu.getMenu().get(position).id);
	}
